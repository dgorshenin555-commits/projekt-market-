// @ts-nocheck
'use client';
/* RegionMap.tsx — перенос landing_map_gl.jsx: «География» на MapLibre GL с дугами из Москвы.
   window.maplibregl заменён на npm-пакет maplibre-gl. */
